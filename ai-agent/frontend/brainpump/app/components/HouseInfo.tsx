                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    {gameInfo && (
                        <>
                            ...
                            <div className="space-y-1">
                                <p className="text-sm text-gray-400">House Active Balance</p>
                            ...
                            <div className="space-y-1">
                                <p className="text-sm text-gray-400">House Fee %</p>
                                <p className="text-lg">{gameInfo.houseFeePercentage}%</p>
                            </div>
                        </>
                    )}
                </div>
